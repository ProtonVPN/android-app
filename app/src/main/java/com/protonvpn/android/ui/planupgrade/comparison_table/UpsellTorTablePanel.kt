...
@Composable
fun UpsellTorTablePanel(
    modifier: Modifier = Modifier,
    windowInsets: WindowInsets = WindowInsets.systemBars,
) {
    UpsellComparisonTablePanel(
        titleRes = R.string.upsell_panel_tor_title,
        descriptionRes = R.string.upsell_panel_tor_description,
        imageRes = R.drawable.upsell_header_tor,
        windowInsets = windowInsets,
        modifier = modifier,
    ) {
        Column {
            BenefitTableFreePlusHeader()
            BenefitTableRowNoYes(stringResource(R.string.upsell_panel_tor_benefit_tor))
