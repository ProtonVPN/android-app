...
@Composable
fun UpsellProfilesTablePanel(
    modifier: Modifier = Modifier,
    windowInsets: WindowInsets = WindowInsets.systemBars
) {
    UpsellComparisonTablePanel(
        titleRes = R.string.upsell_panel_profiles_title,
        descriptionRes = R.string.upsell_panel_profiles_description,
        imageRes = R.drawable.upsell_header_profiles,
        ...
        Column {
            ...
            BenefitTableRow(
                stringResource(R.string.upsell_panel_profiles_benefit_profiles),
                "%d".format(0),
                stringResource(R.string.upsell_panel_profiles_benefit_profiles_unlimited),
            )
