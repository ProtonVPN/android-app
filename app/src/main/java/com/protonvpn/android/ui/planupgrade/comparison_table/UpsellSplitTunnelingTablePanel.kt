...
@Composable
fun UpsellSplitTunnelingTablePanel(
    freeCountries: Int,
    ...
    UpsellComparisonTablePanel(
        titleRes = R.string.upsell_panel_split_tunneling_title,
        descriptionRes = R.string.upsell_panel_split_tunneling_description,
        imageRes = R.drawable.upsell_header_split_tunneling,
        windowInsets = windowInsets,
        modifier = modifier,
    ) {
        Column {
            BenefitTableFreePlusHeader()
            BenefitTableRowNoYes(stringResource(R.string.upsell_panel_split_tunneling_benefit_split))
            BenefitTableRow(
