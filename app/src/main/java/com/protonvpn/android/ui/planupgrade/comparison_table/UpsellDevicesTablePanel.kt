...
fun UpsellDevicesTablePanel(
    ...
    UpsellComparisonTablePanel(
        titleRes = R.string.upsell_panel_devices_title,
        descriptionRes = R.string.upsell_panel_devices_description,
        imageRes = R.drawable.upsell_header_devices,
