...
object CountryTools {
    ...
    val oldMapLocations = mapOf(
        "AD" to CountryData(-1.0, -1.0, Continent.Europe),
        ...
        "BI" to CountryData(-1.0, -1.0, Continent.America),
        "BN" to CountryData(-1.0, -1.0, Continent.Asia),
        "BO" to CountryData(-1.0, -1.0, Continent.America),
        ...
        "CD" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        "CF" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        ...
        "GA" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        "GB" to CountryData(2265.0, 475.0, Continent.Europe),
        "GE" to CountryData(2915.0, 648.0, Continent.Asia),
        "GH" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        "GL" to CountryData(-1.0, -1.0, Continent.America),
        "GN" to CountryData(2043.1508, 1234.0961, Continent.AfricaAndMiddleEast),
        "GR" to CountryData(2600.0, 720.0, Continent.Europe),
        "GQ" to CountryData(2423.6443, 1373.2677, Continent.AfricaAndMiddleEast),
        ...
        "HT" to CountryData(-1.0, -1.0, Continent.America),
        ...
        "JM" to CountryData(-1.0, -1.0, Continent.America),
        ...
        "KW" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        "KG" to CountryData(-1.0, -1.0, Continent.Asia),
        ...
        "LB" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        "LI" to CountryData(-1.0, -1.0, Continent.Europe),
        ...
        "MC" to CountryData(-1.0, -1.0, Continent.Asia),
        ...
        "MN" to CountryData(-1.0, -1.0, Continent.Asia),
        "MO" to CountryData(-1.0, -1.0, Continent.Asia),
        ...
        "NI" to CountryData(-1.0, -1.0, Continent.America),
        ...
        "PA" to CountryData(-1.0, -1.0, Continent.America),
        "PE" to CountryData(1056.0, 1589.0, Continent.America),
        "PG" to CountryData(-1.0, -1.0, Continent.Oceania),
        ...
        "PS" to CountryData(2798.0, 828.0, Continent.AfricaAndMiddleEast),
        "PT" to CountryData(2148.0, 688.0, Continent.Europe),
        "PY" to CountryData(-1.0, -1.0, Continent.America),
        ...
        "SZ" to CountryData(-1.0, -1.0, Continent.AfricaAndMiddleEast),
        ...
        "UY" to CountryData(-1.0, -1.0, Continent.America),
