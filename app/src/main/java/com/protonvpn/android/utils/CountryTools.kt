...
object CountryTools {
    ...
    fun getFlagResource(context: Context, flag: String?): Int {
        val flagPrefix = if (context.isTV()) "_flag_hd" else "_flag"
        val desiredFlag = context.resources.getIdentifier(
                flag?.toLowerCase(Locale.ROOT) + flagPrefix, "drawable", context.packageName)
    ...
    enum class Continent(@StringRes val nameRes: Int, @DrawableRes val iconRes: Int) {
        ...
        Africa(R.string.nameAfrica, R.drawable.africa),
    ...
    val locationMap = mapOf(
        ...
        "CY" to CountryData(2759.0, 777.0, Continent.Asia),
        ...
        "EG" to CountryData(2742.0, 863.0, Continent.Africa),
        ...
        "IL" to CountryData(2793.0, 830.0, Continent.Asia),
        ...
        "SL" to CountryData(2483.0, 575.0, Continent.Africa),
        "SI" to CountryData(2481.0, 578.0, Continent.Europe),
        "ZA" to CountryData(2629.0, 1950.0, Continent.Africa),
        ...
        "TR" to CountryData(2779.0, 696.0, Continent.Asia),
        "UA" to CountryData(2715.0, 517.0, Continent.Europe),
        "AE" to CountryData(3103.0, 976.0, Continent.Asia),
