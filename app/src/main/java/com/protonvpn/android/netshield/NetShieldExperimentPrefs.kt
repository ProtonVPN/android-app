...
@Reusable
class NetShieldExperimentPrefs @Inject constructor(
    ...
    var experimentInitialized: Boolean by boolean(false)
    var experimentEnded: Boolean by boolean(false)
    var experimentGroup: String? by string()


    companion object {
        private const val PREFS_NAME = "NetShieldExperimentPrefs"
    }
}