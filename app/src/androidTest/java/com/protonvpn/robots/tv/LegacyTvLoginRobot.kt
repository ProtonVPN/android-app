...
/**
 * [LegacyTvLoginRobot] Contains all actions and verifications for login view
 */
class LegacyTvLoginRobot : BaseRobot() {

    fun waitUntilLoggedIn(): TvCountryListRobot = waitUntilDisplayedByText(R.string.quickConnect)
    fun waitUntilLoginCodeIsDisplayed(): LegacyTvLoginRobot =
            waitUntilDisplayedByText(R.string.tv_login_step3_description)

    fun signIn(): LegacyTvLoginRobot {
        waitUntilDisplayedByText<LegacyTvLoginRobot>(R.string.tv_login_welcome_button)
        clickElementByText<LegacyTvLoginRobot>(R.string.tv_login_welcome_button)
        return LegacyTvLoginRobot()
    }
