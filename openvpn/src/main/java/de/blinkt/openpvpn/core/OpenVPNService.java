...
import de.blinkt.openpvpn.LaunchVPN;
import de.blinkt.openpvpn.R;
import de.blinkt.openpvpn.VpnProfile;
import de.blinkt.openpvpn.activities.MainActivity;
import de.blinkt.openpvpn.api.ExternalAppDatabase;
import de.blinkt.openpvpn.core.VpnStatus.ByteCountListener;
import de.blinkt.openpvpn.core.VpnStatus.StateListener;

import static de.blinkt.openpvpn.core.ConnectionStatus.LEVEL_CONNECTED;
import static de.blinkt.openpvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static de.blinkt.openpvpn.core.NetworkSpace.IpAddress;
...
public abstract class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "de.blinkt.openpvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "de.blinkt.openpvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "de.blinkt.openpvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "de.blinkt.openpvpn.DISCONNECT_VPN";
    ...
    public static final String PAUSE_VPN = "de.blinkt.openpvpn.PAUSE_VPN";
    public static final String RESUME_VPN = "de.blinkt.openpvpn.RESUME_VPN";
    ...
    private void endVpnService() {
        ...
        mOpenVPNThread = null;
        if (!mStarting) {
            // Commenting out this line helped to solve crashes for Samsung A8 device running on Android P
    ...
    public static void initNotificationChannel(Context context) {
        System.out.println("Init notification channel");
        String channelOneName = "ProtonChannel";
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            android.app.NotificationChannel notificationChannel =
                    new android.app.NotificationChannel(OpenVPNService.CHANNEL_ID, channelOneName,
            ...
            if (manager != null) {
                ...
                System.out.println("created notificaiton channel");
            }
        }
    }
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status) {
        System.out.println("Show notification: " + msg);
        System.out.println("Show notification: " + channel);
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: de.blinkt.openpvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("de.blinkt.openpvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("de.blinkt.openpvpn.VPN_STATUS");
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        if (mDisplayBytecount) {
            ...
            System.out.println("updateytecount");
    ...
    public void requestInputFromUser(int resid, String needed) {
        ...
        System.out.println("requestfrominput");
