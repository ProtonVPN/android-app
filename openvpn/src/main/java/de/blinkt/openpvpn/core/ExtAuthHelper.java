...
import de.blinkt.openpvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "de.blinkt.openpvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "de.blinkt.openpvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "de.blinkt.openpvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "de.blinkt.openpvpn.api.KEY_DESCRIPTION";
