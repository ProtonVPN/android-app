    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp)
        {
            ...
            if(vpnPermissionIntent != null || neddPassword != 0){
                ...
                shortVPNIntent.setClass(getBaseContext(), de.blinkt.openpvpn.LaunchVPN.class);
                shortVPNIntent.putExtra(de.blinkt.openpvpn.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(de.blinkt.openpvpn.LaunchVPN.EXTRA_HIDELOG, true);
